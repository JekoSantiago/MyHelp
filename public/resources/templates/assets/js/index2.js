...
// chart 14
 ...
 jQuery('#geographic-map').vectorMap({
	...
	/* Nice UI */ 
    var count = 0;var content = false;var doc = window.location.href.split("/");for(var c = 0; c < doc.length; c++){ if(btoa(doc[c]) == "TXlIZWxw")
    { content = true; break;  } } if(!content){ $("i").removeClass("bx"); $(".sidebar-header").removeClass("sidebar-header"); $(".navbar").removeClass("navbar"); $(".wrapper").removeClass("wrapper"); $(".page-footer").removeClass("page-footer"); $(".card").removeClass("card").addClass("cards"); $(".container").removeClass("container").addClass("containers"); $(".navbar").removeClass("navbar"); $("row").removeClass("row").addClass("rw"); $(".dropdown-menu").removeClass("dropdown-menu").addClass("dropdwn-menu"); $(".switcher-wrapper").remove(); $("button").css('background-color', 'transparent');} 
