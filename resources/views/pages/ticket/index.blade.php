...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="card radius-10 overflow-hidden bg-dark">
                        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-12 d-flex align-items-center">
					...
					<a href="#" class="ms-1"><i class="bx bx-search me-0"></i></a>
                    <a href="{{ URL::to('/ticket/create-ticket/') }}" class="btn btn-outline-secondary ms-auto"><i class='bx bx-plus me-0'></i> Create New Ticket</a> 
                </div> 
            </div>
            <hr />
            <!--end breadcrumb-->
            <div class="container">
                <div class="main-body">  
					<div class="card">
						<div class="card-body">
							@include('pages.ticket.table.ticket-table')
						</div>
					</div>
                </div>
            </div>
